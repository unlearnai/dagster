...
from dagster_conda.utils import CONDA_CONFIG_SCHEMA, validate_conda_config

DOCKER_CONTAINER_ID_TAG = "docker/container_id"


class CondaRunLauncher(RunLauncher, ConfigurableClass):
    """Launches runs in a custom conda environment.
    ...
    @classmethod
    def config_type(cls):
        return CONDA_CONFIG_SCHEMA

    @staticmethod
    def from_config_value(inst_data, config_value):
        return CondaRunLauncher(inst_data=inst_data, **config_value)

    def _get_or_create_environment(self):
        # spawn new process that creates the environment
        pass
