...
from .asset import MultiAssetDefinition
...
def build_assets_job(
    name: str,
    assets: List[Union[MultiAssetDefinition]],
    source_assets: Optional[Sequence[Union[ForeignAsset, MultiAssetDefinition]]] = None,
    ...
    Args:
        ...
        assets (List[Union[MultiAssetDefinition]]): A list of assets or
            multi-assets - usually constructed using the :py:func:`@asset` or :py:func:`@multi_asset`
            decorator.
        source_assets (Optional[Sequence[Union[ForeignAsset, MultiAssetDefinition]]]): A list of
    ...
    check.list_param(assets, "assets", of_type=MultiAssetDefinition)
    check.opt_list_param(
        source_assets, "source_assets", of_type=(ForeignAsset, MultiAssetDefinition)
    )
...
def build_source_assets_by_key(
    source_assets: Optional[Sequence[Union[ForeignAsset, MultiAssetDefinition]]]
    ...
    for asset_source in source_assets or []:
        ...
        elif isinstance(asset_source, MultiAssetDefinition):
...
def build_op_deps(
    multi_asset_defs: List[MultiAssetDefinition], source_paths: AbstractSet[AssetKey]
